...
create_QMpdf_for_signatures <- function (qm_list,
  ...
  qm_meta <- tibble::tibble(
    ...
    title  = c("Assemblierung von „Short-Read“-Sequenz-Daten zur
             ...
             FASTA-Format mittels Hausverfahren",
               "Genotypisierung von Listeria monocytogenes aus Genomsequenzdaten
               im FASTA-Format mittels Hausverfahren"),
  ...
  writeLines(c(
    ...
    "  cat('\\\\textbf{Gegenstand der Validierung}',
    '\\n\\n',
    'Vergleich von Pipeline Ergebnissen aus',
    basename(attributes(qm_list)$old_folder),
    'und',
    basename(attributes(qm_list)$new_folder),
    'abgelegt in:',
    '\\n\\n',
    ...
    '\\n\\n',
    'Wurden seit der letzten Validierung Änderungen der Prozesskette vorgenomen?',
    '\\n\\n',
    '[ ]Ja  [ ]Nein',
    '\\n\\n',
    ...
    '\\n\\n',
    '\\\\vspace{2cm}',
    '\\\\textbf{Ergebnis der Validierung}')",
    "  df <- qm_list[[name]]",
    "  cat(",
    "    df %>%",
    ...
    '\\\\textbf{Bewertung}',
    '\\n\\n',
    'Müssen die Änderungen zurückgenommen werden: [ ]Ja  [ ]Nein  [ ]n.z. keine Änd',
    '\\n\\n',
    'Die bioinformatische Prozesskette ist weiterhin valide: [ ]Ja  [ ]Nein',
    '\\n\\n',
    'Wenn Nein, Beschreibung der Maßnahmen:',
    '\\n\\n',
    '\\n\\n',
    '\\n\\n',
    '\\\\vspace{2cm}',
    '\\\\textbf{Datum, Unterschrift Arbeitsbereichsleitung:} \\\\hrulefill',
    '\\n\\n',
    '\\\\vspace{1cm}',
    '\\n\\\\newpage')",
    "}",
