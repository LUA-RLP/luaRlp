...
Falls Probleme bei der Installation auftauchen sind diese meist durch eine
fehlende Proxy-Konfiguration verursacht. Diese lassen sich (innerhalb des LUA) 
durch Ausführen des folgenden Codes lösen:
...
- es kann eine Re-Evaluierung der bioionformatischen Pipelines am LUA-RLP 
durchführen. Mehr dazu via

```
vignette("QM_pipeline_evaluation")
```

Diese Art der Dokumentation stellt sicher, dass die Funktionen wie Dokumentiert
auf dem Rechner des Nutzers ausführbar sind (die Funktionen werden lokal auf dem 
Nutzer-Rechner ausgeführt um die Dokumentation zu erstellen). 
